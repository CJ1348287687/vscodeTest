<template>
  <div class="app-container">
    ...
    >
      ...
      <el-form-item label="用户手机号" prop="elementPhone">
        <el-input
          v-model="queryParams.elementPhone"
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['system:customer:customerListExport']"
          size="mini"
        ...
        <el-form label-width="110px">
          ...
          >
            ...
            <el-button
              ...
              v-loading="saveLoading"
              :disabled="saveLoading"
              v-hasPermi="['system:customer:forwardUser']"
