<template>
  <div class="app-container">
    ...
    >
      <tweet-preview ref="tweetPreview"></tweet-preview>
        ...
        >
          <template slot-scope="scope">
            <el-button
              ...
              v-hasPermi="['system:share:customerListExport']"
...
import { mbTypeListByOrganizationId } from "@/api/system/mb/mb";
  ...
  methods: {
    ...
    handleCustomerExport(row) {
      if (row.recordCount == 0 || row.recordCount == null) {
        ...
        this.queryParamsCustomer.targetType = row.targetType;
        console.log("row", row);
        console.log("row.productTemplate", row.productTemplate);
    ...
    getCustomerList() {
      ...
      customerList(
        ...
        response.rows.forEach((item, index) => {
          ...
          if (item.toOrganizationId == organizationId) {
            item.isForward = 0;
          } else {
            item.isForward = 1;
            item.forwardStatusName =
