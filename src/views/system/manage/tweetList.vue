<template>
  <div class="app-container">
    ...
    <el-table ref="tweetTable" v-loading="loading" :data="tweetList" @selection-change="handleSelectionChange" @sort-change="handleSortChange">
      <el-table-column label="推文来源" prop="organizationName" min-width="200px" header-align="center" align="center" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']"/>
      <el-table-column label="推文编号" prop="tweetId" min-width="100px" header-align="center" align="center" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']"/>
      <el-table-column label="推文标题" prop="tweetTitle" min-width="200px"  header-align="center" align="left" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']"/>
      <el-table-column label="推文属性" prop="tweetCommonFlag" min-width="100px" header-align="center" align="center" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']">
        <template slot-scope="{ row }">
          <span v-if=" row.tweetCommonFlag=='0'">私有</span>
          <span v-if=" row.tweetCommonFlag=='1'">公共</span>
        </template>
      </el-table-column>
      <el-table-column label="创建人" prop="createBy" min-width="150px" header-align="center" align="center" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']"/>
      <el-table-column label="创建时间" prop="createTime" min-width="175px" header-align="center" align="center" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']"/>
      <el-table-column label="渠道入库" prop="channelStatus" min-width="100px" header-align="center" align="center" :show-overflow-tooltip="true" sortable="custom" :sort-orders="['descending', 'ascending']">
        <template slot-scope="{ row }">
